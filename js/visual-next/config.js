module.exports = {
  ...
  statusMappings: {
    ...
    event_id: [
      {value: 1, label: "击杀事件"},
      {value: 2, label: "基地、前哨站被毁"},
      {value: 3, label: "能量机关可激活次数变化"},
      {value: 4, label: "能量机关可进入正在激活"},
      {value: 5, label: "能量机关被激活灯臂数量、平均环数"},
      {value: 6, label: "能量机关被激活"},
      {value: 7, label: "己方英雄进入部署模式"},
      {value: 8, label: "己方英雄造成狙击伤害"},
      {value: 9, label: "对方英雄造成狙击伤害"},
      {value: 10, label: "己方呼叫空中支援"},
      {value: 11, label: "己方空中支援被打断"},
      {value: 12, label: "对方呼叫空中支援"},
      {value: 13, label: "对方空中支援被打断"},
      {value: 14, label: "飞镖命中"},
      {value: 15, label: "双方飞镖闸门开启"},
      {value: 16, label: "己方基地遭到攻击"},
      {value: 17, label: "双方前哨站停转"},
      {value: 18, label: "双方基地护甲展开"},
    ],
    // 连接状态
    connection_state: [
      { value: 0, label: "未连接" },
